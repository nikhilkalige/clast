...
void autogenerated_classes_0(pybind11::module& m)
{
    ...
    py::class_<clang::SourceLocation>(m, "SourceLocation" )
        ...
        //.def("printToString", (std::__cxx11::basic_string<char> (clang::SourceLocation::*)(const clang::SourceManager &) const)&clang::SourceLocation::printToString  )
    ...
    py::class_<clang::SourceRange>(m, "SourceRange" )
        ...
        //.def("print", (void (clang::SourceRange::*)(llvm::raw_ostream &, const clang::SourceManager &) const)&clang::SourceRange::print  )
        //.def("printToString", (std::__cxx11::basic_string<char> (clang::SourceRange::*)(const clang::SourceManager &) const)&clang::SourceRange::printToString  )
        .def("dump", (void (clang::SourceRange::*)(const clang::SourceManager &) const)&clang::SourceRange::dump  )
    ;
    ...
    py::class_<clang::Qualifiers>(m, "Qualifiers" )
        ...
        .def("hasOnlyConst", (bool (clang::Qualifiers::*)() const)&clang::Qualifiers::hasOnlyConst  )
        ...
        .def("hasOnlyVolatile", (bool (clang::Qualifiers::*)() const)&clang::Qualifiers::hasOnlyVolatile  )
        ...
        .def("hasOnlyRestrict", (bool (clang::Qualifiers::*)() const)&clang::Qualifiers::hasOnlyRestrict  )
        ...
        .def("getCVRUQualifiers", (unsigned int (clang::Qualifiers::*)() const)&clang::Qualifiers::getCVRUQualifiers  )
        ...
        .def("getAddressSpace", (clang::LangAS (clang::Qualifiers::*)() const)&clang::Qualifiers::getAddressSpace  )
        .def("hasTargetSpecificAddressSpace", (bool (clang::Qualifiers::*)() const)&clang::Qualifiers::hasTargetSpecificAddressSpace  )
        .def("getAddressSpaceAttributePrintValue", (unsigned int (clang::Qualifiers::*)() const)&clang::Qualifiers::getAddressSpaceAttributePrintValue  )
        .def("setAddressSpace", (void (clang::Qualifiers::*)(clang::LangAS))&clang::Qualifiers::setAddressSpace  )
        .def("removeAddressSpace", (void (clang::Qualifiers::*)())&clang::Qualifiers::removeAddressSpace  )
        .def("addAddressSpace", (void (clang::Qualifiers::*)(clang::LangAS))&clang::Qualifiers::addAddressSpace  )
        ...
        //.def("getAsString", (std::__cxx11::basic_string<char> (clang::Qualifiers::*)() const)&clang::Qualifiers::getAsString  )
        //.def("getAsString", (std::__cxx11::basic_string<char> (clang::Qualifiers::*)(const clang::PrintingPolicy &) const)&clang::Qualifiers::getAsString  )
    ...
    py::class_<clang::QualType>(m, "QualType" )
        ...
        .def("mayBeDynamicClass", (bool (clang::QualType::*)() const)&clang::QualType::mayBeDynamicClass  )
        .def("mayBeNotDynamicClass", (bool (clang::QualType::*)() const)&clang::QualType::mayBeNotDynamicClass  )
        ...
        //.def("getAsString", (std::__cxx11::basic_string<char> (clang::QualType::*)() const)&clang::QualType::getAsString  )
        //.def("getAsString", (std::__cxx11::basic_string<char> (clang::QualType::*)(const clang::PrintingPolicy &) const)&clang::QualType::getAsString  )
        //.def("print", (void (clang::QualType::*)(llvm::raw_ostream &, const clang::PrintingPolicy &, const llvm::Twine &, unsigned int) const)&clang::QualType::print  )
        //.def("getAsStringInternal", (void (clang::QualType::*)(std::__cxx11::basic_string<char> &, const clang::PrintingPolicy &) const)&clang::QualType::getAsStringInternal  )
        ...
        //.def("dump", (void (clang::QualType::*)(llvm::raw_ostream &) const)&clang::QualType::dump  )
        //.def("Profile", (void (clang::QualType::*)(llvm::FoldingSetNodeID &) const)&clang::QualType::Profile  )
        .def("getAddressSpace", (clang::LangAS (clang::QualType::*)() const)&clang::QualType::getAddressSpace  )
        ...
        .def("isNonWeakInMRRWithObjCWeak", (bool (clang::QualType::*)(const clang::ASTContext &) const)&clang::QualType::isNonWeakInMRRWithObjCWeak  )
        .def("isNonTrivialToPrimitiveDefaultInitialize", (clang::QualType::PrimitiveDefaultInitializeKind (clang::QualType::*)() const)&clang::QualType::isNonTrivialToPrimitiveDefaultInitialize  )
        .def("isNonTrivialToPrimitiveCopy", (clang::QualType::PrimitiveCopyKind (clang::QualType::*)() const)&clang::QualType::isNonTrivialToPrimitiveCopy  )
        .def("isNonTrivialToPrimitiveDestructiveMove", (clang::QualType::PrimitiveCopyKind (clang::QualType::*)() const)&clang::QualType::isNonTrivialToPrimitiveDestructiveMove  )
    ...
    py::class_<clang::Type>(m, "Type" )
        ...
        .def("isScopedEnumeralType", (bool (clang::Type::*)() const)&clang::Type::isScopedEnumeralType  )
        ...
        .def("isChar8Type", (bool (clang::Type::*)() const)&clang::Type::isChar8Type  )
        ...
        .def("isFloat16Type", (bool (clang::Type::*)() const)&clang::Type::isFloat16Type  )
        .def("isFloat128Type", (bool (clang::Type::*)() const)&clang::Type::isFloat128Type  )
        ...
        .def("isDependentAddressSpaceType", (bool (clang::Type::*)() const)&clang::Type::isDependentAddressSpaceType  )
        ...
        .def("isAlignValT", (bool (clang::Type::*)() const)&clang::Type::isAlignValT  )
        .def("isStdByteType", (bool (clang::Type::*)() const)&clang::Type::isStdByteType  )
        ...
        .def("isOCLIntelSubgroupAVCMcePayloadType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCMcePayloadType  )
        .def("isOCLIntelSubgroupAVCImePayloadType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCImePayloadType  )
        .def("isOCLIntelSubgroupAVCRefPayloadType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCRefPayloadType  )
        .def("isOCLIntelSubgroupAVCSicPayloadType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCSicPayloadType  )
        .def("isOCLIntelSubgroupAVCMceResultType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCMceResultType  )
        .def("isOCLIntelSubgroupAVCImeResultType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCImeResultType  )
        .def("isOCLIntelSubgroupAVCRefResultType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCRefResultType  )
        .def("isOCLIntelSubgroupAVCSicResultType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCSicResultType  )
        .def("isOCLIntelSubgroupAVCImeResultSingleRefStreamoutType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCImeResultSingleRefStreamoutType  )
        .def("isOCLIntelSubgroupAVCImeResultDualRefStreamoutType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCImeResultDualRefStreamoutType  )
        .def("isOCLIntelSubgroupAVCImeSingleRefStreaminType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCImeSingleRefStreaminType  )
        .def("isOCLIntelSubgroupAVCImeDualRefStreaminType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCImeDualRefStreaminType  )
        .def("isOCLIntelSubgroupAVCType", (bool (clang::Type::*)() const)&clang::Type::isOCLIntelSubgroupAVCType  )
        .def("isOCLExtOpaqueType", (bool (clang::Type::*)() const)&clang::Type::isOCLExtOpaqueType  )
        ...
        .def("getAsRecordDecl", (clang::RecordDecl * (clang::Type::*)() const)&clang::Type::getAsRecordDecl , py::return_value_policy::reference_internal )
        ...
        //.def("getContainedDeducedType", (clang::DeducedType * (clang::Type::*)() const)&clang::Type::getContainedDeducedType , py::return_value_policy::reference_internal )
        ...
        .def("hasAutoForTrailingReturnType", (bool (clang::Type::*)() const)&clang::Type::hasAutoForTrailingReturnType  )
        ...
        //.def("hasAttr", (bool (clang::Type::*)(clang::attr::Kind) const)&clang::Type::hasAttr  )
        ...
        .def("isFixedPointType", (bool (clang::Type::*)() const)&clang::Type::isFixedPointType  )
        .def("isSaturatedFixedPointType", (bool (clang::Type::*)() const)&clang::Type::isSaturatedFixedPointType  )
        .def("isUnsaturatedFixedPointType", (bool (clang::Type::*)() const)&clang::Type::isUnsaturatedFixedPointType  )
        .def("isSignedFixedPointType", (bool (clang::Type::*)() const)&clang::Type::isSignedFixedPointType  )
        .def("isUnsignedFixedPointType", (bool (clang::Type::*)() const)&clang::Type::isUnsignedFixedPointType  )
        ...
        .def("canHaveNullability", (bool (clang::Type::*)(bool) const)&clang::Type::canHaveNullability  )
        ...
        //.def("dump", (void (clang::Type::*)(llvm::raw_ostream &) const)&clang::Type::dump  )
    ;
    ...
    py::class_<clang::DeclarationName>(m, "DeclarationName" )
        ...
        //.def("getAsString", (std::__cxx11::basic_string<char> (clang::DeclarationName::*)() const)&clang::DeclarationName::getAsString  )
        ...
        .def("getCXXDeductionGuideTemplate", (clang::TemplateDecl * (clang::DeclarationName::*)() const)&clang::DeclarationName::getCXXDeductionGuideTemplate , py::return_value_policy::reference_internal )
        ...
        .def("getFETokenInfo", (void * (clang::DeclarationName::*)() const)&clang::DeclarationName::getFETokenInfo  )
    ...
    py::class_<clang::DeclarationNameInfo>(m, "DeclarationNameInfo" )
        ...
        //.def("getAsString", (std::__cxx11::basic_string<char> (clang::DeclarationNameInfo::*)() const)&clang::DeclarationNameInfo::getAsString  )
    ...
    py::class_<clang::Decl, decl_deleter<clang::Decl>::type>(m, "Decl" )
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::Decl::*)() const)&clang::Decl::getBeginLoc  )
        .def("getEndLoc", (clang::SourceLocation (clang::Decl::*)() const)&clang::Decl::getEndLoc  )
        ...
        //.def("setAttrs", (void (clang::Decl::*)(const llvm::SmallVector<clang::Attr *, 4> &))&clang::Decl::setAttrs  )
        //.def("getAttrs", (llvm::SmallVector<clang::Attr *, 4> & (clang::Decl::*)())&clang::Decl::getAttrs  )
        //.def("getAttrs", (const llvm::SmallVector<clang::Attr *, 4> & (clang::Decl::*)() const)&clang::Decl::getAttrs  )
        ...
        //.def("getExternalSourceSymbolAttr", (clang::ExternalSourceSymbolAttr * (clang::Decl::*)() const)&clang::Decl::getExternalSourceSymbolAttr , py::return_value_policy::reference_internal )
        .def("isModulePrivate", (bool (clang::Decl::*)() const)&clang::Decl::isModulePrivate  )
        .def("isExported", (bool (clang::Decl::*)() const)&clang::Decl::isExported  )
        ...
        //.def("getAvailability", (clang::AvailabilityResult (clang::Decl::*)(std::__cxx11::basic_string<char> *, llvm::VersionTuple, llvm::StringRef *) const)&clang::Decl::getAvailability  )
        //.def("getVersionIntroduced", (llvm::VersionTuple (clang::Decl::*)() const)&clang::Decl::getVersionIntroduced  )
        //.def("isDeprecated", (bool (clang::Decl::*)(std::__cxx11::basic_string<char> *) const)&clang::Decl::isDeprecated  )
        //.def("isUnavailable", (bool (clang::Decl::*)(std::__cxx11::basic_string<char> *) const)&clang::Decl::isUnavailable  )
        ...
        .def("hasOwningModule", (bool (clang::Decl::*)() const)&clang::Decl::hasOwningModule  )
        //.def("getOwningModule", (clang::Module * (clang::Decl::*)() const)&clang::Decl::getOwningModule , py::return_value_policy::reference_internal )
        //.def("getOwningModuleForLinkage", (clang::Module * (clang::Decl::*)(bool) const)&clang::Decl::getOwningModuleForLinkage , py::return_value_policy::reference_internal )
        .def("isHidden", (bool (clang::Decl::*)() const)&clang::Decl::isHidden  )
        .def("setVisibleDespiteOwningModule", (void (clang::Decl::*)())&clang::Decl::setVisibleDespiteOwningModule  )
        .def("getModuleOwnershipKind", (clang::Decl::ModuleOwnershipKind (clang::Decl::*)() const)&clang::Decl::getModuleOwnershipKind  )
        .def("setModuleOwnershipKind", (void (clang::Decl::*)(clang::Decl::ModuleOwnershipKind))&clang::Decl::setModuleOwnershipKind  )
        ...
        .def("isTemplated", (bool (clang::Decl::*)() const)&clang::Decl::isTemplated  )
        ...
        //.def("dump", (void (clang::Decl::*)(llvm::raw_ostream &, bool) const)&clang::Decl::dump  )
        .def("getID", (long (clang::Decl::*)() const)&clang::Decl::getID  )
    ...
    py::class_<clang::DeclContext>(m, "DeclContext" )
        ...
        .def("getExternCContext", (const clang::LinkageSpecDecl * (clang::DeclContext::*)() const)&clang::DeclContext::getExternCContext , py::return_value_policy::reference_internal )
        ...
        .def("containsDeclAndLoad", (bool (clang::DeclContext::*)(clang::Decl *) const)&clang::DeclContext::containsDeclAndLoad  )
        ...
        //.def("noload_lookups", (llvm::iterator_range<clang::DeclContext::all_lookups_iterator> (clang::DeclContext::*)(bool) const)&clang::DeclContext::noload_lookups  )
        ...
        .def("setHasExternalLexicalStorage", (void (clang::DeclContext::*)(bool) const)&clang::DeclContext::setHasExternalLexicalStorage  )
        .def("hasExternalVisibleStorage", (bool (clang::DeclContext::*)() const)&clang::DeclContext::hasExternalVisibleStorage  )
        .def("setHasExternalVisibleStorage", (void (clang::DeclContext::*)(bool) const)&clang::DeclContext::setHasExternalVisibleStorage  )
        .def("isDeclInLexicalTraversal", (bool (clang::DeclContext::*)(const clang::Decl *) const)&clang::DeclContext::isDeclInLexicalTraversal  )
        .def("setUseQualifiedLookup", (bool (clang::DeclContext::*)(bool) const)&clang::DeclContext::setUseQualifiedLookup  )
        ...
        //.def("dumpLookups", (void (clang::DeclContext::*)(llvm::raw_ostream &, bool, bool) const)&clang::DeclContext::dumpLookups  )
    ;
    ...
    py::class_<clang::NamedDecl, decl_deleter<clang::NamedDecl>::type>(m, "NamedDecl" , py::base<clang::Decl>())
        ...
        //.def("getNameAsString", (std::__cxx11::basic_string<char> (clang::NamedDecl::*)() const)&clang::NamedDecl::getNameAsString  )
        ...
        //.def("getQualifiedNameAsString", (std::__cxx11::basic_string<char> (clang::NamedDecl::*)() const)&clang::NamedDecl::getQualifiedNameAsString  )
        ...
        .def("isExternallyDeclarable", (bool (clang::NamedDecl::*)() const)&clang::NamedDecl::isExternallyDeclarable  )
    ...
    py::class_<clang::NamespaceDecl, decl_deleter<clang::NamespaceDecl>::type>(m, "NamespaceDecl" , py::base<clang::NamedDecl>())
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::NamespaceDecl::*)() const)&clang::NamespaceDecl::getBeginLoc  )
    ...
    py::class_<clang::DeclaratorDecl, decl_deleter<clang::DeclaratorDecl>::type>(m, "DeclaratorDecl" , py::base<clang::ValueDecl>())
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::DeclaratorDecl::*)() const)&clang::DeclaratorDecl::getBeginLoc  )
    ...
    py::class_<clang::VarDecl, decl_deleter<clang::VarDecl>::type>(m, "VarDecl" , py::base<clang::DeclaratorDecl>())
        ...
        .def("isThisDeclarationADemotedDefinition", (bool (clang::VarDecl::*)() const)&clang::VarDecl::isThisDeclarationADemotedDefinition  )
        .def("demoteThisDefinitionToDeclaration", (void (clang::VarDecl::*)())&clang::VarDecl::demoteThisDefinitionToDeclaration  )
        ...
        .def("isObjCForDecl", (bool (clang::VarDecl::*)() const)&clang::VarDecl::isObjCForDecl  )
        .def("setObjCForDecl", (void (clang::VarDecl::*)(bool))&clang::VarDecl::setObjCForDecl  )
        ...
        .def("isEscapingByref", (bool (clang::VarDecl::*)() const)&clang::VarDecl::isEscapingByref  )
        .def("isNonEscapingByref", (bool (clang::VarDecl::*)() const)&clang::VarDecl::isNonEscapingByref  )
        .def("setEscapingByref", (void (clang::VarDecl::*)())&clang::VarDecl::setEscapingByref  )
        .def("getTemplateInstantiationPattern", (clang::VarDecl * (clang::VarDecl::*)() const)&clang::VarDecl::getTemplateInstantiationPattern , py::return_value_policy::reference_internal )
        ...
        .def("isKnownToBeDefined", (bool (clang::VarDecl::*)() const)&clang::VarDecl::isKnownToBeDefined  )
        .def("isNoDestroy", (bool (clang::VarDecl::*)(const clang::ASTContext &) const)&clang::VarDecl::isNoDestroy  )
    ;

    py::class_<clang::ImplicitParamDecl, decl_deleter<clang::ImplicitParamDecl>::type>(m, "ImplicitParamDecl" , py::base<clang::VarDecl>())

        .def("getParameterKind", (clang::ImplicitParamDecl::ImplicitParamKind (clang::ImplicitParamDecl::*)() const)&clang::ImplicitParamDecl::getParameterKind  )
    ;
    ...
    py::class_<clang::FunctionDecl, decl_deleter<clang::FunctionDecl>::type>(m, "FunctionDecl" , py::base<clang::DeclaratorDecl>())
        ...
        .def("isTrivialForCall", (bool (clang::FunctionDecl::*)() const)&clang::FunctionDecl::isTrivialForCall  )
        .def("setTrivialForCall", (void (clang::FunctionDecl::*)(bool))&clang::FunctionDecl::setTrivialForCall  )
        ...
        .def("setHasWrittenPrototype", (void (clang::FunctionDecl::*)(bool))&clang::FunctionDecl::setHasWrittenPrototype  )
        ...
        .def("instantiationIsPending", (bool (clang::FunctionDecl::*)() const)&clang::FunctionDecl::instantiationIsPending  )
        .def("setInstantiationIsPending", (void (clang::FunctionDecl::*)(bool))&clang::FunctionDecl::setInstantiationIsPending  )
        ...
        .def("isReplaceableGlobalAllocationFunction", (bool (clang::FunctionDecl::*)(bool *) const)&clang::FunctionDecl::isReplaceableGlobalAllocationFunction  )
        .def("isDestroyingOperatorDelete", (bool (clang::FunctionDecl::*)() const)&clang::FunctionDecl::isDestroyingOperatorDelete  )
        ...
        .def("willHaveBody", (bool (clang::FunctionDecl::*)() const)&clang::FunctionDecl::willHaveBody  )
        .def("setWillHaveBody", (void (clang::FunctionDecl::*)(bool))&clang::FunctionDecl::setWillHaveBody  )
        .def("isMultiVersion", (bool (clang::FunctionDecl::*)() const)&clang::FunctionDecl::isMultiVersion  )
        .def("setIsMultiVersion", (void (clang::FunctionDecl::*)(bool))&clang::FunctionDecl::setIsMultiVersion  )
        .def("getMultiVersionKind", (clang::MultiVersionKind (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getMultiVersionKind  )
        .def("isCPUDispatchMultiVersion", (bool (clang::FunctionDecl::*)() const)&clang::FunctionDecl::isCPUDispatchMultiVersion  )
        .def("isCPUSpecificMultiVersion", (bool (clang::FunctionDecl::*)() const)&clang::FunctionDecl::isCPUSpecificMultiVersion  )
        .def("isTargetMultiVersion", (bool (clang::FunctionDecl::*)() const)&clang::FunctionDecl::isTargetMultiVersion  )
        ...
        //.def("parameters", (llvm::MutableArrayRef<clang::ParmVarDecl *> (clang::FunctionDecl::*)())&clang::FunctionDecl::parameters  )
        ...
        .def("getDeclaredReturnType", (clang::QualType (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getDeclaredReturnType  )
        .def("getExceptionSpecSourceRange", (clang::SourceRange (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getExceptionSpecSourceRange  )
        ...
        .def("setStorageClass", (void (clang::FunctionDecl::*)(clang::StorageClass))&clang::FunctionDecl::setStorageClass  )
        ...
        .def("setImplicitlyInline", (void (clang::FunctionDecl::*)(bool))&clang::FunctionDecl::setImplicitlyInline  )
        .def("isInlined", (bool (clang::FunctionDecl::*)() const)&clang::FunctionDecl::isInlined  )
        .def("isExplicitSpecified", (bool (clang::FunctionDecl::*)() const)&clang::FunctionDecl::isExplicitSpecified  )
        .def("setExplicitSpecified", (void (clang::FunctionDecl::*)(bool))&clang::FunctionDecl::setExplicitSpecified  )
        ...
        .def("getODRHash", []( clang::FunctionDecl& self) -> unsigned int {
         return self.getODRHash();
        } )
        .def("getODRHash", [](const clang::FunctionDecl& self) -> unsigned int {
         return self.getODRHash();
        } )
    ;
    ...
    py::class_<clang::FieldDecl, decl_deleter<clang::FieldDecl>::type>(m, "FieldDecl" , py::base<clang::DeclaratorDecl>())
        ...
        .def("isZeroLengthBitField", (bool (clang::FieldDecl::*)(const clang::ASTContext &) const)&clang::FieldDecl::isZeroLengthBitField  )
    ...
    py::class_<clang::TypeDecl, decl_deleter<clang::TypeDecl>::type>(m, "TypeDecl" , py::base<clang::NamedDecl>())
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::TypeDecl::*)() const)&clang::TypeDecl::getBeginLoc  )
    ...
    py::class_<clang::TypedefNameDecl, decl_deleter<clang::TypedefNameDecl>::type>(m, "TypedefNameDecl" , py::base<clang::TypeDecl>())
        ...
        .def("isTransparentTag", (bool (clang::TypedefNameDecl::*)() const)&clang::TypedefNameDecl::isTransparentTag  )
    ;
    ...
    py::class_<clang::TagDecl, decl_deleter<clang::TagDecl>::type>(m, "TagDecl" , py::base<clang::TypeDecl>())
        ...
        .def("mayHaveOutOfDateDef", (bool (clang::TagDecl::*)() const)&clang::TagDecl::mayHaveOutOfDateDef  )
    ...
    py::class_<clang::EnumDecl, decl_deleter<clang::EnumDecl>::type>(m, "EnumDecl" , py::base<clang::TagDecl>())
        ...
        .def("getODRHash", (unsigned int (clang::EnumDecl::*)())&clang::EnumDecl::getODRHash  )
        .def("isComplete", (bool (clang::EnumDecl::*)() const)&clang::EnumDecl::isComplete  )
        .def("isClosed", (bool (clang::EnumDecl::*)() const)&clang::EnumDecl::isClosed  )
        .def("isClosedFlag", (bool (clang::EnumDecl::*)() const)&clang::EnumDecl::isClosedFlag  )
        .def("isClosedNonFlag", (bool (clang::EnumDecl::*)() const)&clang::EnumDecl::isClosedNonFlag  )
    ...
    py::class_<clang::RecordDecl, decl_deleter<clang::RecordDecl>::type>(m, "RecordDecl" , py::base<clang::TagDecl>())
        ...
        .def("setHasLoadedFieldsFromExternalStorage", (void (clang::RecordDecl::*)(bool) const)&clang::RecordDecl::setHasLoadedFieldsFromExternalStorage  )
        .def("isNonTrivialToPrimitiveDefaultInitialize", (bool (clang::RecordDecl::*)() const)&clang::RecordDecl::isNonTrivialToPrimitiveDefaultInitialize  )
        .def("setNonTrivialToPrimitiveDefaultInitialize", (void (clang::RecordDecl::*)(bool))&clang::RecordDecl::setNonTrivialToPrimitiveDefaultInitialize  )
        .def("isNonTrivialToPrimitiveCopy", (bool (clang::RecordDecl::*)() const)&clang::RecordDecl::isNonTrivialToPrimitiveCopy  )
        .def("setNonTrivialToPrimitiveCopy", (void (clang::RecordDecl::*)(bool))&clang::RecordDecl::setNonTrivialToPrimitiveCopy  )
        .def("isNonTrivialToPrimitiveDestroy", (bool (clang::RecordDecl::*)() const)&clang::RecordDecl::isNonTrivialToPrimitiveDestroy  )
        .def("setNonTrivialToPrimitiveDestroy", (void (clang::RecordDecl::*)(bool))&clang::RecordDecl::setNonTrivialToPrimitiveDestroy  )
        .def("canPassInRegisters", (bool (clang::RecordDecl::*)() const)&clang::RecordDecl::canPassInRegisters  )
        .def("getArgPassingRestrictions", (clang::RecordDecl::ArgPassingKind (clang::RecordDecl::*)() const)&clang::RecordDecl::getArgPassingRestrictions  )
        .def("setArgPassingRestrictions", (void (clang::RecordDecl::*)(clang::RecordDecl::ArgPassingKind))&clang::RecordDecl::setArgPassingRestrictions  )
        .def("isParamDestroyedInCallee", (bool (clang::RecordDecl::*)() const)&clang::RecordDecl::isParamDestroyedInCallee  )
        .def("setParamDestroyedInCallee", (void (clang::RecordDecl::*)(bool))&clang::RecordDecl::setParamDestroyedInCallee  )
    ...
    py::class_<clang::BlockDecl, decl_deleter<clang::BlockDecl>::type>(m, "BlockDecl" , py::base<clang::Decl>())
        ...
        //.def("parameters", (llvm::MutableArrayRef<clang::ParmVarDecl *> (clang::BlockDecl::*)())&clang::BlockDecl::parameters  )
        ...
        .def("setCapturesCXXThis", (void (clang::BlockDecl::*)(bool))&clang::BlockDecl::setCapturesCXXThis  )
        ...
        .def("doesNotEscape", (bool (clang::BlockDecl::*)() const)&clang::BlockDecl::doesNotEscape  )
        .def("setDoesNotEscape", (void (clang::BlockDecl::*)(bool))&clang::BlockDecl::setDoesNotEscape  )
    ...
    py::class_<clang::CapturedDecl, decl_deleter<clang::CapturedDecl>::type>(m, "CapturedDecl" , py::base<clang::Decl>())
        ...
        //.def("parameters", (llvm::ArrayRef<clang::ImplicitParamDecl *> (clang::CapturedDecl::*)() const)&clang::CapturedDecl::parameters  )
        //.def("parameters", (llvm::MutableArrayRef<clang::ImplicitParamDecl *> (clang::CapturedDecl::*)())&clang::CapturedDecl::parameters  )
    ...
    py::class_<clang::ExportDecl, decl_deleter<clang::ExportDecl>::type>(m, "ExportDecl" , py::base<clang::Decl>())

        .def("getExportLoc", (clang::SourceLocation (clang::ExportDecl::*)() const)&clang::ExportDecl::getExportLoc  )
        .def("getRBraceLoc", (clang::SourceLocation (clang::ExportDecl::*)() const)&clang::ExportDecl::getRBraceLoc  )
        .def("setRBraceLoc", (void (clang::ExportDecl::*)(clang::SourceLocation))&clang::ExportDecl::setRBraceLoc  )
        .def("getEndLoc", (clang::SourceLocation (clang::ExportDecl::*)() const)&clang::ExportDecl::getEndLoc  )
        .def("getSourceRange", (clang::SourceRange (clang::ExportDecl::*)() const)&clang::ExportDecl::getSourceRange  )
    ;
    ...
    py::class_<clang::Stmt, stmt_deleter<clang::Stmt>::type>(m, "Stmt" )
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::Stmt::*)() const)&clang::Stmt::getBeginLoc  )
        .def("getEndLoc", (clang::SourceLocation (clang::Stmt::*)() const)&clang::Stmt::getEndLoc  )
        ...
        .def("getID", (long (clang::Stmt::*)(const clang::ASTContext &) const)&clang::Stmt::getID  )
        ...
        //.def("printPretty", (void (clang::Stmt::*)(llvm::raw_ostream &, clang::PrinterHelper *, const clang::PrintingPolicy &, unsigned int, llvm::StringRef, const clang::ASTContext *) const)&clang::Stmt::printPretty  )
        ...
        .def("IgnoreImplicit", [](const clang::Stmt& self) -> const clang::Stmt * {
         return self.IgnoreImplicit();
        } , py::return_value_policy::reference_internal)
        .def("IgnoreContainers", []( clang::Stmt& self, bool IgnoreCaptured) -> clang::Stmt * {
         return self.IgnoreContainers(IgnoreCaptured);
        } , py::return_value_policy::reference_internal)
        .def("IgnoreContainers", [](const clang::Stmt& self, bool IgnoreCaptured) -> const clang::Stmt * {
         return self.IgnoreContainers(IgnoreCaptured);
        } , py::return_value_policy::reference_internal)
        ...
        //.def("ProcessODRHash", (void (clang::Stmt::*)(llvm::FoldingSetNodeID &, clang::ODRHash &) const)&clang::Stmt::ProcessODRHash  )
    ;
    ...
    py::class_<clang::DeclStmt, stmt_deleter<clang::DeclStmt>::type>(m, "DeclStmt" , py::base<clang::Stmt>())
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::DeclStmt::*)() const)&clang::DeclStmt::getBeginLoc  )
    ...
    py::class_<clang::NullStmt, stmt_deleter<clang::NullStmt>::type>(m, "NullStmt" , py::base<clang::Stmt>())
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::NullStmt::*)() const)&clang::NullStmt::getBeginLoc  )
        .def("getEndLoc", (clang::SourceLocation (clang::NullStmt::*)() const)&clang::NullStmt::getEndLoc  )
    ...
    py::class_<clang::CompoundStmt, stmt_deleter<clang::CompoundStmt>::type>(m, "CompoundStmt" , py::base<clang::Stmt>())
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::CompoundStmt::*)() const)&clang::CompoundStmt::getBeginLoc  )
        .def("getEndLoc", (clang::SourceLocation (clang::CompoundStmt::*)() const)&clang::CompoundStmt::getEndLoc  )
    ...
    py::class_<clang::SwitchCase, stmt_deleter<clang::SwitchCase>::type>(m, "SwitchCase" , py::base<clang::Stmt>())
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::SwitchCase::*)() const)&clang::SwitchCase::getBeginLoc  )
        .def("getEndLoc", (clang::SourceLocation (clang::SwitchCase::*)() const)&clang::SwitchCase::getEndLoc  )
    ;

    py::class_<clang::CaseStmt, stmt_deleter<clang::CaseStmt>::type>(m, "CaseStmt" , py::base<clang::SwitchCase>())

        .def("caseStmtIsGNURange", (bool (clang::CaseStmt::*)() const)&clang::CaseStmt::caseStmtIsGNURange  )
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::CaseStmt::*)() const)&clang::CaseStmt::getBeginLoc  )
        .def("getEndLoc", (clang::SourceLocation (clang::CaseStmt::*)() const)&clang::CaseStmt::getEndLoc  )
    ...
    py::class_<clang::DefaultStmt, stmt_deleter<clang::DefaultStmt>::type>(m, "DefaultStmt" , py::base<clang::SwitchCase>())
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::DefaultStmt::*)() const)&clang::DefaultStmt::getBeginLoc  )
        .def("getEndLoc", (clang::SourceLocation (clang::DefaultStmt::*)() const)&clang::DefaultStmt::getEndLoc  )
    ...
    py::class_<clang::LabelStmt, stmt_deleter<clang::LabelStmt>::type>(m, "LabelStmt" , py::base<clang::Stmt>())
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::LabelStmt::*)() const)&clang::LabelStmt::getBeginLoc  )
        .def("getEndLoc", (clang::SourceLocation (clang::LabelStmt::*)() const)&clang::LabelStmt::getEndLoc  )
    ...
    py::class_<clang::AttributedStmt, stmt_deleter<clang::AttributedStmt>::type>(m, "AttributedStmt" , py::base<clang::Stmt>())
        ...
        .def("getBeginLoc", (clang::SourceLocation (clang::AttributedStmt::*)() const)&clang::AttributedStmt::getBeginLoc  )
        .def("getEndLoc", (clang::SourceLocation (clang::AttributedStmt::*)() const)&clang::AttributedStmt::getEndLoc  )
    ...
    py::class_<clang::IfStmt, stmt_deleter<clang::IfStmt>::type>(m, "IfStmt" , py::base<clang::Stmt>())
        ...
        .def("hasInitStorage", (bool (clang::IfStmt::*)() const)&clang::IfStmt::hasInitStorage  )
        .def("hasVarStorage", (bool (clang::IfStmt::*)() const)&clang::IfStmt::hasVarStorage  )
        .def("hasElseStorage", (bool (clang::IfStmt::*)() const)&clang::IfStmt::hasElseStorage  )
        ...
        .def("getConditionVariable", []( clang::IfStmt& self) -> clang::VarDecl * {
         return self.getConditionVariable();
        } , py::return_value_policy::reference_internal)
        .def("getConditionVariable", [](const clang::IfStmt& self) -> const clang::VarDecl * {
         return self.getConditionVariable();
        } , py::return_value_policy::reference_internal)
        .def("setConditionVariable", (void (clang::IfStmt::*)(const clang::ASTContext &, clang::VarDecl *))&clang::IfStmt::setConditionVariable  )
        .def("getConditionVariableDeclStmt", []( clang::IfStmt& self) -> clang::DeclStmt * {
        ...
        .def("isObjCAvailabilityCheck", (bool (clang::IfStmt::*)() const)&clang::IfStmt::isObjCAvailabilityCheck  )
        .def("getBeginLoc", (clang::SourceLocation (clang::IfStmt::*)() const)&clang::IfStmt::getBeginLoc  )
        .def("getEndLoc", (clang::SourceLocation (clang::IfStmt::*)() const)&clang::IfStmt::getEndLoc  )
