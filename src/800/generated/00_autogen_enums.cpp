...
void autogenerated_enums(pybind11::module& m)
{
    ...
    py::enum_<clang::AtomicExpr::AtomicOp>(m.attr("AtomicExpr"), "clang_AtomicExpr_AtomicOp")
        ...
        .value("AO__opencl_atomic_init", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_init)
        .value("AO__opencl_atomic_load", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_load)
        .value("AO__opencl_atomic_store", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_store)
        .value("AO__opencl_atomic_exchange", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_exchange)
        .value("AO__opencl_atomic_compare_exchange_strong", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_compare_exchange_strong)
        .value("AO__opencl_atomic_compare_exchange_weak", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_compare_exchange_weak)
        .value("AO__opencl_atomic_fetch_add", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_fetch_add)
        .value("AO__opencl_atomic_fetch_sub", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_fetch_sub)
        .value("AO__opencl_atomic_fetch_and", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_fetch_and)
        .value("AO__opencl_atomic_fetch_or", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_fetch_or)
        .value("AO__opencl_atomic_fetch_xor", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_fetch_xor)
        .value("AO__opencl_atomic_fetch_min", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_fetch_min)
        .value("AO__opencl_atomic_fetch_max", clang::AtomicExpr::AtomicOp::AO__opencl_atomic_fetch_max)
        .value("AO__atomic_fetch_min", clang::AtomicExpr::AtomicOp::AO__atomic_fetch_min)
        .value("AO__atomic_fetch_max", clang::AtomicExpr::AtomicOp::AO__atomic_fetch_max)
    ...
    py::enum_<clang::BinaryOperatorKind>(m, "clang_BinaryOperatorKind")
        ...
        .value("BO_Cmp", clang::BinaryOperatorKind::BO_Cmp)
    ...
    py::enum_<clang::CallExpr::ADLCallKind>(m.attr("CallExpr"), "clang_CallExpr_ADLCallKind")
        .value("NotADL", clang::CallExpr::ADLCallKind::NotADL)
        .value("UsesADL", clang::CallExpr::ADLCallKind::UsesADL)
        .export_values();
    ;
    ...
    py::enum_<clang::CallingConv>(m, "clang_CallingConv")
        ...
        .value("CC_Win64", clang::CallingConv::CC_Win64)
        .value("CC_X86_64SysV", clang::CallingConv::CC_X86_64SysV)
        .value("CC_X86RegCall", clang::CallingConv::CC_X86RegCall)
        ...
        .value("CC_AArch64VectorCall", clang::CallingConv::CC_AArch64VectorCall)
        .export_values();
    ;

    py::enum_<clang::CapturedRegionKind>(m, "clang_CapturedRegionKind")
        .value("CR_Default", clang::CapturedRegionKind::CR_Default)
        .value("CR_ObjCAtFinally", clang::CapturedRegionKind::CR_ObjCAtFinally)
    ...
    py::enum_<clang::CastKind>(m, "clang_CastKind")
        ...
        .value("CK_FixedPointCast", clang::CastKind::CK_FixedPointCast)
        .value("CK_FixedPointToBoolean", clang::CastKind::CK_FixedPointToBoolean)
        ...
        .value("CK_ZeroToOCLOpaqueType", clang::CastKind::CK_ZeroToOCLOpaqueType)
        .value("CK_AddressSpaceConversion", clang::CastKind::CK_AddressSpaceConversion)
        .value("CK_IntToOCLSampler", clang::CastKind::CK_IntToOCLSampler)
        .export_values();
    ;
    ...
    py::enum_<clang::Decl::Kind>(m.attr("Decl"), "clang_Decl_Kind")
        ...
        .value("Export", clang::Decl::Kind::Export)
        ...
        .value("UsingPack", clang::Decl::Kind::UsingPack)
        ...
        .value("CXXDeductionGuide", clang::Decl::Kind::CXXDeductionGuide)
        ...
        .value("OMPRequires", clang::Decl::Kind::OMPRequires)
    ...
    py::enum_<clang::Decl::ModuleOwnershipKind>(m.attr("Decl"), "clang_Decl_ModuleOwnershipKind")
        .value("Unowned", clang::Decl::ModuleOwnershipKind::Unowned)
        .value("Visible", clang::Decl::ModuleOwnershipKind::Visible)
        .value("VisibleWhenImported", clang::Decl::ModuleOwnershipKind::VisibleWhenImported)
        .value("ModulePrivate", clang::Decl::ModuleOwnershipKind::ModulePrivate)
        .export_values();
    ;
    ...
    py::enum_<clang::DeclarationName::NameKind>(m.attr("DeclarationName"), "clang_DeclarationName_NameKind")
        ...
        .value("CXXDeductionGuideName", clang::DeclarationName::NameKind::CXXDeductionGuideName)
    ...
    py::enum_<clang::Expr::ConstExprUsage>(m.attr("Expr"), "clang_Expr_ConstExprUsage")
        .value("EvaluateForCodeGen", clang::Expr::ConstExprUsage::EvaluateForCodeGen)
        .value("EvaluateForMangling", clang::Expr::ConstExprUsage::EvaluateForMangling)
        .export_values();
    ;
    ...
    py::enum_<clang::Expr::isModifiableLvalueResult>(m.attr("Expr"), "clang_Expr_isModifiableLvalueResult")
        ...
        .value("MLV_ConstQualifiedField", clang::Expr::isModifiableLvalueResult::MLV_ConstQualifiedField)
    ...
    py::enum_<clang::ImplicitParamDecl::ImplicitParamKind>(m.attr("ImplicitParamDecl"), "clang_ImplicitParamDecl_ImplicitParamKind")
        .value("ObjCSelf", clang::ImplicitParamDecl::ImplicitParamKind::ObjCSelf)
        .value("ObjCCmd", clang::ImplicitParamDecl::ImplicitParamKind::ObjCCmd)
        .value("CXXThis", clang::ImplicitParamDecl::ImplicitParamKind::CXXThis)
        .value("CXXVTT", clang::ImplicitParamDecl::ImplicitParamKind::CXXVTT)
        .value("CapturedContext", clang::ImplicitParamDecl::ImplicitParamKind::CapturedContext)
        .value("Other", clang::ImplicitParamDecl::ImplicitParamKind::Other)
        .export_values();
    ;
    ...
    py::enum_<clang::LangAS>(m, "clang_LangAS")
        .value("Default", clang::LangAS::Default)
        .value("opencl_global", clang::LangAS::opencl_global)
        .value("opencl_local", clang::LangAS::opencl_local)
        .value("opencl_constant", clang::LangAS::opencl_constant)
        .value("opencl_private", clang::LangAS::opencl_private)
        .value("opencl_generic", clang::LangAS::opencl_generic)
        .value("cuda_device", clang::LangAS::cuda_device)
        .value("cuda_constant", clang::LangAS::cuda_constant)
        .value("cuda_shared", clang::LangAS::cuda_shared)
        .value("FirstTargetAddressSpace", clang::LangAS::FirstTargetAddressSpace)
        .export_values();
    ;
    ...
    py::enum_<clang::Linkage>(m, "clang_Linkage")
        ...
        .value("ModuleInternalLinkage", clang::Linkage::ModuleInternalLinkage)
        .value("ModuleLinkage", clang::Linkage::ModuleLinkage)
    ...
    py::enum_<clang::MultiVersionKind>(m, "clang_MultiVersionKind")
        .value("None", clang::MultiVersionKind::None)
        .value("Target", clang::MultiVersionKind::Target)
        .value("CPUSpecific", clang::MultiVersionKind::CPUSpecific)
        .value("CPUDispatch", clang::MultiVersionKind::CPUDispatch)
        .export_values();
    ;
    ...
    py::enum_<clang::OverloadedOperatorKind>(m, "clang_OverloadedOperatorKind")
        ...
        .value("OO_Spaceship", clang::OverloadedOperatorKind::OO_Spaceship)
    ...
    py::enum_<clang::PredefinedExpr::IdentKind>(m.attr("PredefinedExpr"), "clang_PredefinedExpr_IdentKind")
        .value("Func", clang::PredefinedExpr::IdentKind::Func)
        .value("Function", clang::PredefinedExpr::IdentKind::Function)
        .value("LFunction", clang::PredefinedExpr::IdentKind::LFunction)
        .value("FuncDName", clang::PredefinedExpr::IdentKind::FuncDName)
        .value("FuncSig", clang::PredefinedExpr::IdentKind::FuncSig)
        .value("LFuncSig", clang::PredefinedExpr::IdentKind::LFuncSig)
        .value("PrettyFunction", clang::PredefinedExpr::IdentKind::PrettyFunction)
        .value("PrettyFunctionNoVirtual", clang::PredefinedExpr::IdentKind::PrettyFunctionNoVirtual)
        .export_values();
    ;
    ...
    py::enum_<clang::QualType::DestructionKind>(m.attr("QualType"), "clang_QualType_DestructionKind")
        ...
        .value("DK_nontrivial_c_struct", clang::QualType::DestructionKind::DK_nontrivial_c_struct)
        .export_values();
    ;

    py::enum_<clang::QualType::PrimitiveCopyKind>(m.attr("QualType"), "clang_QualType_PrimitiveCopyKind")
        .value("PCK_Trivial", clang::QualType::PrimitiveCopyKind::PCK_Trivial)
        .value("PCK_VolatileTrivial", clang::QualType::PrimitiveCopyKind::PCK_VolatileTrivial)
        .value("PCK_ARCStrong", clang::QualType::PrimitiveCopyKind::PCK_ARCStrong)
        .value("PCK_ARCWeak", clang::QualType::PrimitiveCopyKind::PCK_ARCWeak)
        .value("PCK_Struct", clang::QualType::PrimitiveCopyKind::PCK_Struct)
        .export_values();
    ;

    py::enum_<clang::QualType::PrimitiveDefaultInitializeKind>(m.attr("QualType"), "clang_QualType_PrimitiveDefaultInitializeKind")
        .value("PDIK_Trivial", clang::QualType::PrimitiveDefaultInitializeKind::PDIK_Trivial)
        .value("PDIK_ARCStrong", clang::QualType::PrimitiveDefaultInitializeKind::PDIK_ARCStrong)
        .value("PDIK_ARCWeak", clang::QualType::PrimitiveDefaultInitializeKind::PDIK_ARCWeak)
        .value("PDIK_Struct", clang::QualType::PrimitiveDefaultInitializeKind::PDIK_Struct)
        .export_values();
    ;
    ...
    py::enum_<clang::RecordDecl::ArgPassingKind>(m.attr("RecordDecl"), "clang_RecordDecl_ArgPassingKind")
        .value("APK_CanPassInRegs", clang::RecordDecl::ArgPassingKind::APK_CanPassInRegs)
        .value("APK_CannotPassInRegs", clang::RecordDecl::ArgPassingKind::APK_CannotPassInRegs)
        .value("APK_CanNeverPassInRegs", clang::RecordDecl::ArgPassingKind::APK_CanNeverPassInRegs)
        .export_values();
    ;
    ...
    py::enum_<clang::SourceManager::UnownedTag>(m.attr("SourceManager"), "clang_SourceManager_UnownedTag")
        .value("Unowned", clang::SourceManager::UnownedTag::Unowned)
        .export_values();
    ;
    ...
    py::enum_<clang::Stmt::StmtClass>(m.attr("Stmt"), "clang_Stmt_StmtClass")
        ...
        .value("ArrayInitIndexExprClass", clang::Stmt::StmtClass::ArrayInitIndexExprClass)
        .value("ArrayInitLoopExprClass", clang::Stmt::StmtClass::ArrayInitLoopExprClass)
        ...
        .value("DependentCoawaitExprClass", clang::Stmt::StmtClass::DependentCoawaitExprClass)
        ...
        .value("FixedPointLiteralClass", clang::Stmt::StmtClass::FixedPointLiteralClass)
        .value("FloatingLiteralClass", clang::Stmt::StmtClass::FloatingLiteralClass)
        .value("ConstantExprClass", clang::Stmt::StmtClass::ConstantExprClass)
        .value("ExprWithCleanupsClass", clang::Stmt::StmtClass::ExprWithCleanupsClass)
        .value("firstFullExprConstant", clang::Stmt::StmtClass::firstFullExprConstant)
        .value("lastFullExprConstant", clang::Stmt::StmtClass::lastFullExprConstant)
        ...
        .value("OMPTargetTeamsDistributeDirectiveClass", clang::Stmt::StmtClass::OMPTargetTeamsDistributeDirectiveClass)
        .value("OMPTargetTeamsDistributeParallelForDirectiveClass", clang::Stmt::StmtClass::OMPTargetTeamsDistributeParallelForDirectiveClass)
        .value("OMPTargetTeamsDistributeParallelForSimdDirectiveClass", clang::Stmt::StmtClass::OMPTargetTeamsDistributeParallelForSimdDirectiveClass)
        .value("OMPTargetTeamsDistributeSimdDirectiveClass", clang::Stmt::StmtClass::OMPTargetTeamsDistributeSimdDirectiveClass)
        ...
        .value("OMPTeamsDistributeDirectiveClass", clang::Stmt::StmtClass::OMPTeamsDistributeDirectiveClass)
        .value("OMPTeamsDistributeParallelForDirectiveClass", clang::Stmt::StmtClass::OMPTeamsDistributeParallelForDirectiveClass)
        .value("OMPTeamsDistributeParallelForSimdDirectiveClass", clang::Stmt::StmtClass::OMPTeamsDistributeParallelForSimdDirectiveClass)
        .value("OMPTeamsDistributeSimdDirectiveClass", clang::Stmt::StmtClass::OMPTeamsDistributeSimdDirectiveClass)
        ...
        .value("OMPTargetTeamsDirectiveClass", clang::Stmt::StmtClass::OMPTargetTeamsDirectiveClass)
    ...
    py::enum_<clang::Type::ScalarTypeKind>(m.attr("Type"), "clang_Type_ScalarTypeKind")
        ...
        .value("STK_FixedPoint", clang::Type::ScalarTypeKind::STK_FixedPoint)
        .export_values();
    ;
    ...
    py::enum_<clang::Type::TypeClass>(m.attr("Type"), "clang_Type_TypeClass")
        ...
        .value("DependentAddressSpace", clang::Type::TypeClass::DependentAddressSpace)
        .value("Vector", clang::Type::TypeClass::Vector)
        .value("DependentVector", clang::Type::TypeClass::DependentVector)
        ...
        .value("DeducedTemplateSpecialization", clang::Type::TypeClass::DeducedTemplateSpecialization)
        ...
        .value("ObjCTypeParam", clang::Type::TypeClass::ObjCTypeParam)
    ...
    py::enum_<clang::TypeTrait>(m, "clang_TypeTrait")
        ...
        .value("UTT_IsAggregate", clang::TypeTrait::UTT_IsAggregate)
        ...
        .value("UTT_IsTriviallyDestructible", clang::TypeTrait::UTT_IsTriviallyDestructible)
        ...
        .value("UTT_HasUniqueObjectRepresentations", clang::TypeTrait::UTT_HasUniqueObjectRepresentations)
        ...
        .value("BTT_ReferenceBindsToTemporary", clang::TypeTrait::BTT_ReferenceBindsToTemporary)
    ...
    py::enum_<clang::UnaryExprOrTypeTrait>(m, "clang_UnaryExprOrTypeTrait")
        ...
        .value("UETT_PreferredAlignOf", clang::UnaryExprOrTypeTrait::UETT_PreferredAlignOf)
        .export_values();
    ;
